...
<script type="text/javascript">
    ...
    Highcharts.chart('browser', {
        ...
        series: [{
            ...
            colorByPoint: true,
            data: [
            @foreach($visitorid_browser as $key => $value)
    ...
    Highcharts.chart('os', {
        ...
        series: [{
            ...
            colorByPoint: true,
            data: [
            @foreach($visitorid_os as $key => $value)
            @if($value['os'] == 'unknown')
            @else
            {
                name: '{{$value['os']}}',
                ...
                <div class="row">
                    <div class="col-lg-3 col-xs-6">
                        <div class="small-box bg-light-blue">
                            ...
                            <a href="{{ url(config('backpack.base.route_prefix', 'admin') . '/speakers') }}" class="small-box-footer">Больше <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-xs-6">
                        <div class="small-box bg-fuchsia">
                            ...
                            <a href="{{ url(config('backpack.base.route_prefix', 'admin') . '/bars') }}" class="small-box-footer">Больше <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-xs-6">
                        <div class="small-box bg-orange">
                            ...
                            <a href="{{ url(config('backpack.base.route_prefix', 'admin') . '/partners') }}" class="small-box-footer">Больше <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-xs-6">
                        <div class="small-box bg-olive">
                            ...
                            <a href="{{ url(config('backpack.base.route_prefix', 'admin') . '/programs') }}" class="small-box-footer">Больше <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="row">
