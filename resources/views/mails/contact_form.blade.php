												...
												<table cellpadding="0" cellspacing="0" width="100%">
													<tr>
														<td style="text-align:center; font-size:30px; padding-bottom:20px;">
															Поступила новая заявка на желание купить билет!
														</td>
													</tr>
												</table>
												...
												<table cellspacing="0" cellpadding="0" width="100%">
													...
													<tr>
														<td style="padding-top:5px; vertical-align:top;">
															<b>Имя -  </b> {{ $contact->name }} <br>
															<b>Город -  </b> {{ $contact->city }} <br>
															<b>Организация -  </b> {{ $contact->organization }} <br>
															<b>Должность -  </b> {{ $contact->position }} <br>
															<b>Телефон -  </b> {{ $contact->phone }} <br><br>
