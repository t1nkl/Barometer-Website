...
<head>
	...
	<title>Barometer Contact Form</title>
	<style type="text/css">
								...
								<table class="full-width-gmail-android" cellspacing="0" cellpadding="0" border="0" width="100%">
									<tr>
										<td class="header center" width="100%">
											<a href="http://www.barometer.show">
												Barometer
											</a>
										</td>
									</tr>
												...
												<table cellpadding="0" cellspacing="0" width="100%">
													<tr>
														<td style="text-align:center; font-size:30px; padding-bottom:20px;">
															Поступила новая заявка на желание стать участником!
														</td>
													</tr>
												</table>
												...
												<table cellspacing="0" cellpadding="0" width="100%">
													...
													<tr>
														<td style="padding-top:5px; vertical-align:top;">
															<b>Имя -  </b> {{ $member->name }} <br>
															<b>Город -  </b> {{ $member->city }} <br>
															<b>Организация -  </b> {{ $member->organization }} <br>
															<b>Должность -  </b> {{ $member->position }} <br>
															<b>Телефон -  </b> {{ $member->phone }} <br><br>
															<b>E-mail -  </b> {{ $member->email }} <br>
														</td>
													</tr>
												</table>
											</td>
